                ...
                <div className="row">
                  <div className="col-md-4 col-lg-4 pe-5">
                    ...
                    <p className="text-neutral pt-3" style={{ fontSize: 20 }}>
                      ...
                      labor-intensive coworking space environment. Everything
                  ...
                  <div className="col-md-4 col-lg-4 pe-5">
                    ...
                    <p className="text-neutral pt-3" style={{ fontSize: 20 }}>
                      meet all the needs of the office that you want and
                      according to all the needs that you want
                    </p>
                  </div>
              ...
              >
                <div className="row">
                  <div
                    ...
                    style={{ paddingTop: 100, marginRight: 90 }}
                  >
                    <h3 className="fw-bold" style={{ fontSize: 34 }}>
                      Find answers to questions about
                      <span className="text-primary fw-bold">Office Zone</span>
                    </h3>
                    <span style={{ fontSize: 20 }}>
                      Provide every answer of all your questions and needs.
                    </span>
                  </div>
                    ...
                    >
                      <div className="accordion-item pt-3">
                        ...
                        >
                          <div className="accordion-body pt-3">
                            You can also add access to printing and scanning
                            facilities, full call management services, mail
                            delivery, tea and coffee, catering, custom designed
                            offices, furniture and equipment, and additional
                      ...
                      <div className="accordion-item pt-3">
                        <h2 className="accordion-header" id="flush-headingTwo">
                          ...
                          >
                            I don't want to be tied to a long term office lease
                            contract, can I use the office space for my small
                            team?
                          </button>
                        </h2>
                        <div
                        ...
                        >
                          <div className="accordion-body">
                            We understand that small businesses often don't want
                            to be bound by long-term contracts. With our
                            flexible contracts, you can rent space for any
                            length of time - from a few weeks to several months.
                            We also offer memberships so you only pay for what
                            you need.
                          </div>
                        </div>
                      </div>
                      <div className="accordion-item pt-3">
                        ...
                        >
                          ...
                          >
                            May we put our logo on the workspace or should we
                            use the provided decorations and furnishings?
                          </button>
                        </h2>
                        <div
                        ...
                        >
                          <div className="accordion-body">
                            All of our workspaces are designed with simple décor
                            and ergonomic furnishings, but we understand the
                            importance of having a space that feels like your
                            own. You can put a logo on the room, or if you want
                            a more unique office, you can adjust the lavout and
                            choose furniture that suits your business and
                            business culture with a dedicated office.
                          </div>
                        </div>
                      </div>
                      <div className="accordion-item pt-3">
                        ...
                        >
                          <div className="accordion-body ">
                            Our workspace is a gathering place for a variety of
                            dynamic businesses with several lounges and
                            community areas to do a lot of activities and
            ...
            <div className="row mb-3 d-flex justify-content-center">
              <div className="col-md-12 col-lg-12 pt-5">
                <div className="row">
                  ...
                  <div className="col-md-3 col-lg-3">
                    <img src={room2} className="room2" alt="room2" />
                  </div>
                  <div
                  ...
                  >
                    ...
                    <div>
                      <img src={google} className="google pe-4" alt="google" />
